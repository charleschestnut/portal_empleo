...
from portal.views.labour import *
from portal.views.other_methods.populate import populate
from portal.views.profile.profile_edit import profile_edit
from portal.views.rating.client_rating.client_rating_create import client_rating_create
